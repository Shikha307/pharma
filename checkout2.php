            ...
            <div class="col-lg-12">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li aria-current="page" class="breadcrumb-item active">Checkout - Delivery</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-3">
              ...
              <div class="box">
                <form method="get" action="checkout2.php">
                  ...
                  <div class="box-footer d-flex justify-content-between"><a href="checkout1.php" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to address</a>
                    ...
                    ?>
                    <a href="checkout3.php?aid=<?php echo $a_id; ?>" class="btn btn-outline-secondary">Continue to Payment Method<i class="fa fa-chevron-right"></i></a>
                    <?php
                  }
                  ?>
                  </div>
