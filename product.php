...
.has-search .form-control-feedback {
  ...
  <body>
          ...
          if (isset($_SESSION["username"])) {
           ...
           ?>
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="addproduct.php" class="dropdown-item">Add Product Images</a>                
    ...
    <input type="text" name="name" required placeholder="Product Name" class="form-control rounded-pill form-control-lg" style="margin-top: 150px;">    
